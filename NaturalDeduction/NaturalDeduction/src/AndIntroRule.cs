...
{
    class AndIntroRule : Rule
    {
        Statement firstStatement;
        Statement aboveStatement;

        public AndIntroRule(Solution solution, Statement firstStatement, Statement aboveStatement, Statement baseStatement) : base(solution, baseStatement)
        {
        ...
        public override void Solve()
        {
            ...
            Console.WriteLine("And Introduction!");
